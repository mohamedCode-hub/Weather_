...
void loadWeatherTextures(HMODULE hModule) {
    cloudyTexture = loadTextureFromResource(hModule, IDR_RCDATA1);
    sunnyTexture = loadTextureFromResource(hModule, IDR_RCDATA2);
    rainyTexture = loadTextureFromResource(hModule, IDR_RCDATA3);
    snowyTexture = loadTextureFromResource(hModule, IDR_RCDATA4);
